...
#include "../../LibraryManageSystem/returnbook.h"
...
QT_MOC_LITERAL(1, 11, 14), // "ReturnBookSlot"
QT_MOC_LITERAL(2, 26, 0) // ""

    },
    "ReturnBook\0ReturnBookSlot\0"
};
...
void ReturnBook::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ReturnBook *_t = static_cast<ReturnBook *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->ReturnBookSlot(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject ReturnBook::staticMetaObject = {
    { &Form::staticMetaObject, qt_meta_stringdata_ReturnBook.data,
      qt_meta_data_ReturnBook,  qt_static_metacall, nullptr, nullptr}
};
...
void *ReturnBook::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ReturnBook.stringdata0))
        return static_cast<void*>(const_cast< ReturnBook*>(this));
